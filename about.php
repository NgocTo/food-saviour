...
<main class="text-dark">
    ...
    <hr />
    <h2 class="text-green about-padding">About</h2>
    <div class="about-container">
        <section class="about">
            <h3 class="text-green">Breakfast Club</h3>
    ...
    <div class="member-container">
        ...
        <section class="member">
            ...
            <h3 class="text-green">Wren Chen</h3>
        ...
        <section class="member">
            ...
            <h3 class="text-green">Elena Race</h3>
        ...
        <section class="member">
            ...
            <h3 class="text-green">Ngoc To</h3>
